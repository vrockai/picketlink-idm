 ...
 * @author vrockai
 */
public class RelationshipManagerDBWorker extends PerformanceWorker {
    ...
    public RelationshipManagerDBWorker(IdentitySessionFactory identitySessionFactory) {
        super(identitySessionFactory);
    }

    public RelationshipManagerDBWorker(IdentitySessionFactory identitySessionFactory, int size) {
        super(identitySessionFactory, size);
    }

    public RelationshipManagerDBWorker(IdentitySessionFactory identitySessionFactory, int size, TestMethod testType) {
        super(identitySessionFactory, size);
