...
public class TestBase extends TestCase {
	...
	public String username = "gatein";
	public String password = "gatein";
	public String connUrl = "jdbc:mysql://localhost/gatein";
	...
	protected void startDatabase() throws Exception {
		try {
			...
			ex.printStackTrace();
			logger.fine("Exception during database startup.");
			throw ex;
		}
	}
